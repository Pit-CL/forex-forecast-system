"""
Pipeline orchestration for 30-day forex forecasting.
...
def run_forecast_pipeline(
    ...
    """
    Execute the complete 30-day forecasting pipeline.
    ...
    3. Generate 30-day forecast using ensemble models
    ...
    Example:
        ...
        ... )
    """
    logger.info("Starting 30-day forecast pipeline")
...
def _send_email(settings, report_path: Path) -> None:
    ...
    # sender.send(
    #     subject=f"Proyección USD/CLP 30 días - {datetime.now():%Y-%m-%d}",
    #     body="Se adjunta la proyección de tipo de cambio para los próximos 30 días.",
