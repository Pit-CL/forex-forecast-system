"""
Command-line interface for 7-day forecaster service.
...
app = typer.Typer(
    name="forecaster-7d",
    help="7-day USD/CLP forex forecasting service",
...
def run(
    ...
    log_file: Optional[Path] = typer.Option(
        None,
        "--log-file",
        help="Path to log file (default: logs/forecaster_7d.log)",
    ),
) -> None:
    """
    Run the 7-day forecast pipeline.
    ...
    Examples:
        ...
        $ python -m services.forecaster_7d.cli run -o ./my_reports -l DEBUG
    """
    # Configure logging
    if log_file is None:
        log_file = Path("./logs/forecaster_7d.log")
...
def validate(
    ...
    Examples:
        ...
        $ python -m services.forecaster_7d.cli validate -l DEBUG
    """
...
def backtest(
    ...
    Examples:
        ...
        $ python -m services.forecaster_7d.cli backtest -d 60 -o ./backtest_results
    """
    configure_logging(level=log_level)
...
def info() -> None:
    ...
    console.print("\n[bold cyan]Forecaster 7D - Configuration[/bold cyan]")
    console.print("=" * 60)
