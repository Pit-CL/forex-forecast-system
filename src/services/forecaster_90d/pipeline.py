"""
Pipeline orchestration for 90-day forex forecasting.
...
def run_forecast_pipeline(
    ...
    """
    Execute the complete 90-day forecasting pipeline.
    ...
    3. Generate 90-day forecast using ensemble models
    ...
    Example:
        ...
        ... )
    """
    logger.info("Starting 90-day forecast pipeline")
...
def _send_email(settings, report_path: Path) -> None:
    ...
    # sender.send(
    #     subject=f"Proyección USD/CLP 90 días - {datetime.now():%Y-%m-%d}",
    #     body="Se adjunta la proyección de tipo de cambio para los próximos 90 días.",
