...
def load_latest_forecast_data(horizon: str, project_root: Path):
    """Load data from the latest forecast execution."""
    # Find the latest forecast report JSON (generated by forecaster)
    reports_dir = project_root / "reports"

    # Try to find recent forecast data
    # For now, we'll use sample data structure that matches real forecast output
    # In production, this would read from actual forecast JSON output
    ...
    data = {
        ...
        "system_health": {
            ...
            "score": 95,
            "predictions": 28,
            "performance": "EXCELLENT (RMSE: 8.2 CLP, MAPE: 0.9%)",
