...
from routers import forecasts_router, indicators_router, news_router, drivers_router, history_router, market_indicators_router
    ...
    try:
        ...
        if not settings.development_mode:
            ...
            for file in forecast_files:
                file_path = settings.output_path / "forecasts" / file
        ...
        return HealthStatus(
            status="healthy" if data_sources["forecasts"] else "degraded",
            timestamp=datetime.now(),
            version=settings.api_version,
